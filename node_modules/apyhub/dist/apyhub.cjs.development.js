      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 9:
              _context2.next = 11;
              return fetch__default(request.url, {
                method: "GET",
...
function getFormData(file, fieldName) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(file), _step; !(_step = _iterator()).done;) {
    var f = _step.value;
    if (typeof f === "string") {
      var absoluteFilePath = path.resolve(f);
      var fileBuffer = fs.readFileSync(absoluteFilePath);
...
function getFile(filePath) {
  ...
  var file = fs.readFileSync(absoluteFilePath);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 9;
            return fetch__default(data.data);
          case 9:
...
exports.convert = index$6;
exports.countries = countries;
exports.country = country;
exports.crop = crop;
exports.csvToExcel = csvToExcel;
exports.currencyConverter = currencyConverter;
exports.currencyList = currencyList;
exports.data = index$5;
exports.download = download;
exports.email = email;
exports.extract = index$4;
exports.fuzzy = fuzzy;
exports.generate = index$3;
exports.htmlToPdf = htmlToPdf;
exports.ical = ical;
exports.imageMetadata = imageMetadata;
exports.imageProcessor = index$2;
exports.imageToPdf = imageToPdf;
exports.initApyhub = initApyhub;
exports.markdownToHtml = markdownToHtml;
exports.pdf = pdf;
exports.postcode = postcode;
exports.presentationToPdf = presentationToPdf;
exports.qr = qr;
exports.resize = resize;
exports.screenshot = screenshot;
exports.search = index;
exports.spreadsheetToPdf = spreadsheetToPdf;
exports.textFromPdf = textFromPdf;
exports.textFromWebpage = textFromWebpage;
exports.textFromWord = textFromWord;
...
//# sourceMappingURL=apyhub.cjs.development.js.map
