 ...
 */
declare function ical({ output, responseFormat, summary, description, organizerEmail, attendeesEmails, location, timeZone, startTime, endTime, meetingDate, recurring, recurrence, }: {
    output?: string;
